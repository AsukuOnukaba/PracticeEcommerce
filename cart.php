...
<footer class="section-p1">
    <div class="col">
        ...
        <h4>Contact</h4>
        <p><strong>Address:</strong> no.120 crescent, Gaduwa estate, Abuja</p>
        <p><strong>Phone:</strong> +234 802 043 3900</p>
        <div class="follow">
            <h4>follow us</h4>
        </div>
        <div class="copyright" style="margin-left: -2.3em;">
            <p style="margin-left: 30px">2022 E-commerce. All Rights Reserved </p>
        </div>
    </div>
